...
//class to convert the given graph into a minimum spanning graph
public class MST extends JPanel
{
    ...
    public MST(KruskalsAlgorithm _parent) {
        // constructor with kruskals object sets vertices ,edges 
        super();
        parent = _parent;
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < graphVertices.size(); ++i) {
            ...
            g.fillOval(currentVertex.p.x - parent.NODE_RADIUS,
                   ...
                   2*parent.NODE_RADIUS, 2*parent.NODE_RADIUS);//x y width height
